 ...
 return (
   <div className="min-h-screen bg-background text-foreground">
     <main className="page-wrapper bg-background min-h-screen">
       ...
       <section className="container pt-6 py-lg-8">
         <div className="row g-5">
           {/* Main column */}
           <div className="col-lg-8">
             <div className="d-flex justify-content-between align-items-center mb-3">
               <h2 className="h3 fw-bold mb-0">Recommended for you</h2>
               <Link href="/library" className="link-primary">
                 See all
               </Link>
             </div>
                   ...
                   <div className="card border-0 shadow-sm rounded-4 h-100">
                     ...
                     <div className="card-body">
                       ...
                       <Link href="/library-page" className="stretched-link text-decoration-none">
                         <h3 className="h6 fw-bold mb-2">6th Grade Math Lesson Walkthrough</h3>
                       </Link>
                       <p className="text-muted small mb-0">Workbook with activities and teacher‑friendly guides.</p>
                     </div>
                   </div>
                 </div>
               ))}
           ...
           <aside className="col-lg-4">
             <div className="position-sticky" style={{ top: 96 }}>
               <div className="mb-4">
                 <h3 className="h5 fw-bold">Featured posts</h3>
               </div>
               {[
                 {
                 ...
                 {
                   title: "6th Grade Math Lesson Walkthrough",
                   icon: "bx bx-file",
                   tag: "PDF Download",
                   href: "/library-page",
                 },
               ].map((p, idx) => (
                 <div className="card border-0 shadow-sm rounded-4 mb-3" key={idx}>
                   <div className="card-body p-4">
                     <Link href={p.href} className="text-decoration-none">
                       <h4 className="h6 fw-bold mb-2">{p.title}</h4>
                     </Link>
               ...
               {/* Newsletter */}
               <div
                 className="card border-0 shadow rounded-4 mt-4 text-white"
                 style={{ background: "linear-gradient(135deg, #2563eb, #7c3aed)" }}
               >
                 <div className="card-body p-4">
                   <h4 className="h5 fw-bold">Stay updated</h4>
                   <p className="small text-white-50">Get the latest PD resources in your inbox.</p>
                   <div className="d-flex gap-2">
                   ...
                   <div className="small text-white-50 mt-2">Join 50,000+ educators</div>
                 </div>
               </div>
             </div>
           </aside>
       ...
       <section className="pt-6 py-lg-8 border-top border-bottom bg-body">
...
const videoCards: Video[] = [
 {
   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/How%20to%20Create%20and%20Assign%20Quick%20Assessments%20with%20Erudyte-LIpSUBnYKO14hogvBX0BdBovEO20yW.png",
 ...
 {
   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Culturally%20Relevant%20and%20SEL%20Practices%20for%20Your%20Diverse%20Classroom-kKsbfJQvYGJhJhJhJhJhJhJhJh.png",
 ...
 {
   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/collaborative%20Teaching%20Strategies-%20A%20World%20of%20Difference%20in%20Diverse%20Classrooms-kKsbfJQvYGJhJhJhJhJhJhJhJh.png",
 ...
 {
   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Data-Driven%20Instruction-%20Using%20Assessment%20Data%20Effectively-kKsbfJQvYGJhJhJhJhJhJhJhJh.png",
