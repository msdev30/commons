...
/* =========================================================
   Top "On this page" for mobile/tablet
========================================================= */
function MobileTOC() {
  const active = useActiveSection(tocSections.map((s) => s.id))
  return (
    <div className="lg:hidden sticky top-20 z-20 mt-6 rounded-2xl border border-zinc-200/70 bg-white/70 dark:border-zinc-800/60 dark:bg-zinc-900/50 backdrop-blur-md">
...
function StickyTOC() {
  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col gap-1 px-2 policy-toc">
        {tocSections.map((s) => {
          const isActive = active === s.id
          return (
            <a
              ...
              aria-current={isActive ? "true" : undefined}
              className={[
                "group flex items-center gap-2 rounded-xl px-3 py-2 text-[13px] transition-colors no-underline",
                isActive
                  ? "bg-emerald-500/10 text-foreground ring-1 ring-emerald-400"
                  : "text-muted-foreground hover:bg-muted hover:text-foreground"
              ].join(" ")}
            >
              <ChevronRight
                className={[
                  "h-3.5 w-3.5 transition-transform text-zinc-400",
                  isActive ? "translate-x-0.5 text-emerald-600" : "-translate-x-0.5"
                ].join(" ")}
              />
              <span>{s.label}</span>
            </a>
      ...
      {/* Policy quicklinks (neutral pills; no underline) */}
      <div className="mt-6 px-3">
        <Card className="border-dashed">
          ...
          <CardContent className="space-y-2">
            <Link
              href="#standards"
              className="inline-flex items-center gap-2 text-xs px-2.5 py-1.5 rounded-full ring-1 ring-zinc-300/70 dark:ring-zinc-700/70 text-foreground hover:bg-zinc-100 dark:hover:bg-zinc-800 transition no-underline"
            >
...
export default function Page() {
  ...
  // Soft hero gradient (no harsh blues), pill cards, and global tweaks for no underlines in TOC
  const heroBg =
  ...
  return (
    <>
      <a
        href="#overview"
        className="sr-only focus:not-sr-only focus:fixed focus:top-3 focus:left-3 focus:z-50 rounded-md bg-emerald-600 px-3 py-2 text-xs font-medium text-white shadow"
      >
        Skip to content
      </a>
      <Navigation />

      {/* Global: make TOC links neutral & no underline */}
      <style jsx global>{`
        .policy-toc a,
      ...
      <div className="fixed bottom-6 right-6 z-40 hidden md:flex items-center gap-2 rounded-2xl border bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/60 p-2 shadow-lg">
        ...
        <Button
          ...
          variant="default"
          className="gap-2"
          onClick={() => navigator.share?.({ title: "Erudyte Accessibility", url: location.href })}
        >
          ...
          <main ref={printRef} className="min-w-0 flex-1">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10">
                  <A11y className="h-6 w-6 text-primary" />
                </div>
                <div>
                  <h1 className="text-3xl font-bold tracking-tight">Accessibility Statement</h1>
                  <p className="text-muted-foreground">Our commitment to inclusive design, universal access, and compliance with international accessibility standards across all Erudyte experiences.</p>
                </div>
              </div>
            ...
            <div className="space-y-12">
              ...
              <Alert className={`${heroBg} border-emerald-200 dark:border-emerald-800 rounded-2xl`}>
                ...
                <AlertTitle className="text-zinc-900 dark:text-zinc-100">Built Access-First</AlertTitle>
                <AlertDescription className="text-zinc-800/80 dark:text-zinc-200/90">
                  We design, build, and test continuously to meet or exceed WCAG 2.2 AA across the platform.
                </AlertDescription>
              </Alert>

              {/* Mobile/Tablet On-this-page just under hero */}
              <MobileTOC />

              {/* Top Meta + Badges */}
              <div id="overview" className="scroll-mt-32">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                  <Card className="md:col-span-3 bg-white/70 dark:bg-zinc-900/60 backdrop-blur-sm rounded-2xl">
                    <CardHeader className="pb-2">
                    ...
                    <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                      <div>
                        ...
                        <div className="text-2xl font-semibold text-emerald-600">WCAG 2.2 AA</div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className="text-2xl font-semibold text-violet-600">{progress}%</div>
                        <Progress className="mt-2" value={progress} />
                      </div>
                    </CardContent>
                  </Card>

                  <Card className="bg-white/70 dark:bg-zinc-900/60 backdrop-blur-sm rounded-2xl">
                    <CardHeader className="pb-2">
                      <CardTitle className="text-base flex items-center gap-2">
                    ...
                    <CardContent className="text-sm space-y-2">
                      <div className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-emerald-600" /> Screen-reader first layouts</div>
                      <div className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-emerald-600" /> Keyboard-only workflows</div>
                      <div className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-emerald-600" /> Captions & transcripts by default</div>
                      <div className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-emerald-600" /> Personalizable UI (contrast, motion)</div>
                    </CardContent>
                  </Card>
                </div>

                <Alert className="mt-6 border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 rounded-2xl">
                  <Info className="h-4 w-4" />
                  <AlertTitle>Our Accessibility Commitment</AlertTitle>
                  <AlertDescription>
                    We continuously test with automated + manual methods and real users with disabilities.
                  </AlertDescription>
                </Alert>
              </div>

              {/* Standards & Compliance */}
              <Section id="standards" title="Accessibility Standards & Legal Compliance" className="scroll-mt-28">
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold mb-3 flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-emerald-600" /> Primary Standards
                    </h4>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 ml-4">
                      ...
                      <li>• CSS-first layouts; graceful no-CSS fallbacks</li>
                      <li>• Progressive enhancement; core UX without JS</li>
                      <li>• Responsive to assistive-tech viewports</li>
                      <li>• Internationalization & bidi support</li>
                    </ul>
                  </div>
                  ...
                  <Tabs defaultValue="aa" className="w-full">
                    ...
                    <TabsContent value="aa">
                      <Alert>
                        ...
                        <AlertDescription>This website conforms to WCAG 2.2 level AA. We test on every release.</AlertDescription>
                      </Alert>
                    </TabsContent>
                    <TabsContent value="aaa">
                      <Card>
                        <CardHeader><CardTitle className="text-base">Areas we pursue</CardTitle></CardHeader>
                        <CardContent className="text-sm text-muted-foreground">AAA criteria such as enhanced contrast, extended captions, and sign-language support where feasible.</CardContent>
                      </Card>
                    </TabsContent>
              ...
              {/* Features */}
              <Section id="features" title="Comprehensive Accessibility Features" className="scroll-mt-28">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <ul className="space-y-1 text-sm">
                        ...
                        <li>• SR-friendly heading structure</li>
                      </ul>
                    </CardContent>
                  </Card>
              ...
              {/* Assistive Tech */}
              <Section id="assistive-tech" title="Assistive Technology Support" className="scroll-mt-28">
              ...
              {/* Testing & QA */}
              <Section id="testing" title="Testing & Quality Assurance" className="scroll-mt-28">
                <div className="space-y-6">
                  <div>
              ...
              {/* Support & Feedback */}
              <Section id="feedback" title="Accessibility Support & Feedback" className="scroll-mt-28">
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card>
                      <CardHeader>
                      ...
                      <CardContent className="space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <Link href="mailto:accessibility@erudyte.com" className="text-foreground no-underline underline-offset-2 hover:opacity-80">
                            accessibility@erudyte.com
                          </Link>
                        </div>
              ...
              <Section id="roadmap" title="Accessibility Roadmap & Known Issues" badge="Updated Monthly" className="scroll-mt-28">
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold mb-3 flex items-center gap-2"><Clock className="h-4 w-4" /> Current Initiatives (2025)</h4>
                    <div className="space-y-3">
                      <div className="flex items-start gap-3"><Badge className="bg-emerald-100 text-emerald-800 border-emerald-200">Q3 2025</Badge><div><p className="font-medium text-sm">Enhanced Mobile Accessibility</p><p className="text-xs text-muted-foreground">Better touch targets, gesture alternatives, mobile SR optimization</p></div></div>
                      <div className="flex items-start gap-3"><Badge className="bg-violet-100 text-violet-800 border-violet-200">Q4 2025</Badge><div><p className="font-medium text-sm">Advanced Personalization</p><p className="text-xs text-muted-foreground">User-customizable accessibility preferences & adaptive UI</p></div></div>
                      <div className="flex items-start gap-3"><Badge className="bg-amber-100 text-amber-800 border-amber-200">2026</Badge><div><p className="font-medium text-sm">AI-Powered Accessibility</p><p className="text-xs text-muted-foreground">Automated alt text, content simplification, predictive features</p></div></div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <Alert className="border-yellow-200 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-950">
                        ...
                        <AlertDescription className="text-yellow-800 dark:text-yellow-200">Some older course materials and PDFs may not meet current standards. We’re updating these and can provide accessible alternatives on request.</AlertDescription>
                      </Alert>
              ...
              {/* FAQ */}
              <Section id="faq" title="Frequently Asked Questions" className="scroll-mt-28">
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1">
                    <AccordionTrigger>How do I request accessible formats?</AccordionTrigger>
                    <AccordionContent>
                      <p className="mb-3">Request via:</p>
                      <ul className="space-y-2 ml-4">
                        <li>• Email <Link href="mailto:accessibility@erudyte.com" className="text-foreground no-underline underline-offset-2 hover:opacity-80">accessibility@erudyte.com</Link></li>
                        <li>• “Request Accessible Format” link on course pages</li>
                        <li>• Your instructor/course coordinator</li>
                      </ul>
                      <p className="mt-3 text-sm text-muted-foreground">Typical turnaround: 48 hours for standard requests.</p>
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="faq-2">
                    <AccordionTrigger>Are all videos captioned with transcripts?</AccordionTrigger>
                    <AccordionContent>
                      <ul className="space-y-1 ml-4">
                        <li>• Captions for all new content</li>
                        <li>• Interactive, downloadable transcripts</li>
                        <li>• Audio descriptions where needed</li>
                      </ul>
                      <p className="mt-3 text-sm">Older content is being retrofitted; target completion: end of 2025.</p>
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="faq-3">
                    <AccordionTrigger>What browsers & AT do you support?</AccordionTrigger>
                    <AccordionContent>
                      <div className="space-y-4">
                        <div>
                          <p className="font-medium mb-2">Browsers</p>
                          <p className="text-sm">Chrome, Firefox, Safari, Edge (current & previous major)</p>
                        </div>
                        <div>
                  ...
                  <AccordionItem value="faq-4">
                    <AccordionTrigger>How fast are accessibility issues fixed?</AccordionTrigger>
                    <AccordionContent>
                      <div className="space-y-2">
                        <div className="flex justify-between items-center"><span className="text-sm font-medium">Critical</span><Badge variant="destructive">24 hours</Badge></div>
                        <div className="flex justify-between items-center"><span className="text-sm font-medium">High</span><Badge variant="secondary">3 business days</Badge></div>
                        <div className="flex justify-between items-center"><span className="text-sm font-medium">Medium</span><Badge variant="outline">2 weeks</Badge></div>
                        <div className="flex justify-between items-center"><span className="text-sm font-medium">Low</span><Badge variant="outline">Next release</Badge></div>
                      </div>
                      <p className="mt-3 text-sm text-muted-foreground">Interim workarounds provided while permanent fixes ship.</p>
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="faq-5">
                    <AccordionTrigger>Do you provide accessibility training?</AccordionTrigger>
                    <AccordionContent>
                      <p className="mb-3">Yes—onboarding, tutorials, 1:1 support, and guides are available.</p>
                      <p className="text-sm">Request a session via the accessibility team email above.</p>
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="faq-6">
                    <AccordionTrigger>How do I customize the interface?</AccordionTrigger>
                    <AccordionContent>
                      <div className="space-y-3">
              ...
              <div className="mt-12 p-6 bg-muted rounded-2xl">
                <div className="flex items-start gap-4">
                  <A11y className="h-6 w-6 text-emerald-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold mb-2">Accessibility is a Journey, Not a Destination</h3>
                    <p className="text-sm text-muted-foreground mb-3">
                      Continuous improvement, community feedback, and inclusive design guide our roadmap.
                    </p>
                    <p className="text-sm">
